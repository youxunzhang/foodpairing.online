...
> 所有调试页面现位于 `internal-tools/` 目录，仅供内部排查问题使用。

#### internal-tools/test-food-simple.html (新增)
- 简化的食物库测试页面
- 快速验证修复效果
- 实时显示测试状态
- 适合快速诊断问题

#### internal-tools/debug-food.html (新增)
- 完整的食物库调试页面
- 详细的状态检查功能
- 实时控制台日志捕获
- 全面的功能测试工具
...
1. **使用 internal-tools/test-food-simple.html**: 快速验证基本功能是否正常
2. **使用 internal-tools/debug-food.html**: 进行详细的诊断和测试
